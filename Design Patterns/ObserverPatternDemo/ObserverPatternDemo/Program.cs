...
namespace ObserverPatternDemo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            carrots.Subscribe(new Restaurant("Mackay's", 0.77));
            carrots.Subscribe(new Restaurant("Johnny's Sports Bar", 0.74));
            carrots.Subscribe(new Restaurant("Salad Kingdom", 0.75));
